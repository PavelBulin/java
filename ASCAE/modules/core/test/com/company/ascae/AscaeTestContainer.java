...
public class AscaeTestContainer extends TestContainer {

    public AscaeTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/ascae/app.properties",
    ...
    public static class Common extends AscaeTestContainer {

        public static final AscaeTestContainer.Common INSTANCE = new AscaeTestContainer.Common();
